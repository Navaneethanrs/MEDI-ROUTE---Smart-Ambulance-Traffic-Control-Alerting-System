  ...
  const slides = [
    {
      ...
      text: "Our system dispatches the nearest available ambulance with real-time traffic corridor routing.",
      image: "/img1.jpg"
    },
    {
      title: "Hospital Coordination",
      text: "Seamlessly coordinate with hospitals to ensure beds and medical staff are ready upon arrival.",
      image: "/hospital.jpg"
    },
    {
      title: "Traffic Management",
      text: "Smart traffic signal control switches corridors to green, reducing transit delay by 40%.",
      image: "/hos dispach.jpg"
    },
    {
      title: "Real-time Tracking",
      text: "Hospitals and emergency services track ambulance locations and patient status in real-time.",
      image: "/tracking.jpg"
    }
  ];
        ...
        <div className="container hero-content">
          ...
          <div className="hero-image">
            <div className="hero-img-card">
              <img src="/img1.jpg" alt="MediRoute Ambulance Dashboard" className="floating-img" />
              <div className="hero-badge badge-1">
                <i className="fas fa-satellite-dish"></i>
                <span>Smart Signals Active</span>
              </div>
      ...
      <section className="features">
        <div className="container">
          ...
          <div className="features-grid">
            <div className="feature-card f-hospital">
              ...
              <span className="card-arrow"><i className="fas fa-arrow-right-long"></i></span>
            </div>
            <div className="feature-card f-bed">
              <div className="feature-card-glow"></div>
              <div className="feature-icon">
                <i className="fas fa-bed-pulse"></i>
              </div>
            ...
            <div className="feature-card f-medical">
              <div className="feature-card-glow"></div>
              <div className="feature-icon">
            ...
            <div className="feature-card f-tracking">
              <div className="feature-card-glow"></div>
              <div className="feature-icon">
            ...
            <div className="feature-card f-traffic">
              <div className="feature-card-glow"></div>
              <div className="feature-icon">
            ...
            <div className="feature-card f-coordination">
              <div className="feature-card-glow"></div>
              <div className="feature-icon">
                <i className="fas fa-heart-circle-bolt"></i>
              </div>
            ...
            {slides.map((slide, index) => (
              <div key={index} className="action-card">
                <div className="action-image-container">
                  <img src={slide.image} alt={slide.title} className="action-image" />
                  <div className="action-overlay">
                    <span className="action-tag">Scenario {index + 1}</span>
                  </div>
                </div>
                <div className="action-content">
                  <h3>{slide.title}</h3>
                  <p>{slide.text}</p>
                  <a href="/about" className="action-link" onClick={(e) => { e.preventDefault(); window.location.href = '/about'; }}>
